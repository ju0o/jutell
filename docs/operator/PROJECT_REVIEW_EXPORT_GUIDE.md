...
| 구분 | 내용 |
|---|---|
| 실제 사용자 설정 | 루트 `.jutell.json`, `.beginner-bridge.json`, `.jutell-operator.local.json`, `opencode.json` — 설정은 CLI 또는 Dashboard가 생성하며, 저장소에는 예시만 존재 (`examples/config/*.example.json`) |
